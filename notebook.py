...
def network_structure(structure='vgg16',dropout=0.5, hidden_layer1 = 4096,lr = 0.001,device='gpu'):
...
def build_model(model, criterion, optimizer, epochs = 3, print_every=40, loader=0, device='gpu'):
    steps = 0
...
def load_checkpoint(path='checkpoint.pth'):
    ...
    model,_,_ = network_structure(structure , dropout,hidden_layer1,lr)
...
def process_image(image_path='/home/workspace/ImageClassifier/flowers/test/1/image_06743.jpg'):
...
def predict(image='/home/workspace/ImageClassifier/flowers/test/1/image_06743.jpg', model=0, topk=5,device='gpu'):
